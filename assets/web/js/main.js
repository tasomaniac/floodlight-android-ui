...
var hackBase = "http://192.168.1.65"; // put a URL here to access a different REST server
...
tpl.loadTemplates(['home', 'status', 'topology', 'switch', 'switch-list', 'switch-list-item', 'host', 'host-list', 'host-list-item', 'port-list', 'port-list-item', 'flow-list', 'flow-list-item'],
    function () {
        app = new AppRouter();
